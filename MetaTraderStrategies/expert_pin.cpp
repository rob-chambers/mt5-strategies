...
//+------------------------------------------------------------------+
//--- inputs for expert
input string Expert_Title         ="Expert_PIN";        // Document name
ulong        Expert_MagicNumber   =27108;               // 
...
input int    Signal__PeriodRSI    =47;                  // CMS_ES_RSI(47,3) Period of RSI
input int    Signal__PeriodMA     =3;                   // CMS_ES_RSI(47,3) Period of MA
input double Signal__Weight       =1.0;                 // CMS_ES_RSI(47,3) Weight [0...1.0]
//--- inputs for money
...
////--- Creating filter CMS_ES_RSI
//   CMS_ES_RSI *filter0=new CMS_ES_RSI;
//   if(filter0==NULL)
//     {
//      //--- failed

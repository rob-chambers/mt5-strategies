...
input double   _inpLots = 0;                                    // Number of lots to trade
input STOPLOSS_RULE _inpInitialStopLossRule = PreviousBar2Pips; // Initial Stop Loss Rule

...
namespace cAlgo.Library.Robots.MACrosser
{
    ...
    public class MACrosserBot : BaseRobot
    {
            ...
            int barsToAllowTradeToDevelop)
        {
            ...
            if (_maCrossRule == MACrosser.MaCrossRule.None && slRule == MACrosser.InitialStopLossRule.None && rule == MACrosser.TrailingStopLossRule.None)
        ...
        {
            if (_initialStopLossRule == MACrosser.InitialStopLossRule.Custom)
            {
        ...
        protected override bool ManageLongPosition()
        {
            ...
            switch (_maCrossRule)
            {
                case MACrosser.MaCrossRule.CloseOnFastMaCross:
                    value = _fastMA.Result.LastValue;
                    maType = "fast";
                    break;

                case MACrosser.MaCrossRule.CloseOnMediumMaCross:
